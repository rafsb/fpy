 ...
 */
    ...
    class Ns {
        ...
        getStyle(t, e) {
            ...
            return void 0 === t && this._cachedMeta.dataset ? this.itemsolveDatasetElementOptions(i) : this.itemsolveDataElementOptions(t || 0, i)
        }
        getContext(t, e, i) {
        ...
        _resolveElementOptions(t, e="default", i) {
            ...
            const l = this.chart.config
              ...
              , f = l.itemsolveNamedOptions(d, u, (()=>this.getContext(i, s, e)), c);
        ...
        _getSharedOptions(t, e) {
            const i = this.itemsolveDataElementOptions(t, e)
    ...
    class An {
        ...
        constructor(t, e) {
            ...
            this.$context = void 0,
            this._doResize = dt((t=>this.update(t)), a.itemsizeDelay || 0),
            this._dataChanges = [],
            Pn[this.id] = this,
        ...
        _initialize() {
            ...
            this.options.itemsponsive ? this.itemsize() : ke(this, this.options.devicePixelRatio),
            this.bindEvents(),
        ...
        _resetElements() {
            u(this.data.datasets, ((t,e)=>{
                this.getDatasetMeta(e).controller.itemset()
            }
            ), this)
        }
        reset() {
        ...
        _checkEventBindings() {
            const t = this.options
              ...
              , i = new Set(t.events);
            P(e, i) && !!this._responsiveListeners === t.itemsponsive || (this.unbindEvents(),
            this.bindEvents())
        }
        ...
        bindEvents() {
            this.bindUserEvents(),
            this.options.itemsponsive ? this.bindResponsiveEvents() : this.attached = !0
        }
        bindUserEvents() {
    ...
    class jn extends Ns {
        ...
        updateElements(t, e, i, s) {
            ...
            for (p = e; p < e + i; ++p) {
                ...
                g && (o.options = f || this.itemsolveDataElementOptions(p, i.active ? "active" : s)),
                m += e,
        ...
        getMaxBorderWidth(t) {
            ...
            for (s = 0,
            n = t.length; s < n; ++s)
                r = a.itemsolveDataElementOptions(s),
        ...
        getMaxOffset(t) {
            ...
            for (let i = 0, s = t.length; i < s; ++i) {
                const t = this.itemsolveDataElementOptions(i);
    ...
    class $n extends Ns {
        ...
        updateElements(t, e, i, s) {
            ...
            for (d = e; d < e + i; d++) {
                ...
                const m = {
                    ...
                    startAngle: i,
                    endAngle: g,
                    options: this.itemsolveDataElementOptions(d, e.active ? "active" : s)
                };
        ...
        _computeAngle(t, e, i) {
            return this.chart.getDataVisibility(t) ? $(this.itemsolveDataElementOptions(t, e).angle || i) : 0
        }
    }
    var Yn = Object.freeze({
        ...
        BarController: class extends Ns {
            ...
            updateElements(t, e, i, n) {
                ...
                for (let f = e; f < e + i; f++) {
                    ...
                    u && (m.options = d || this.itemsolveDataElementOptions(f, t[f].active ? "active" : n));
        ...
        BubbleController: class extends Ns {
            ...
            parsePrimitiveData(t, e, i, s) {
                ...
                for (let t = 0; t < n.length; t++)
                    n[t]._custom = this.itemsolveDataElementOptions(t + i).radius;
                return n
            }
            parseArrayData(t, e, i, s) {
                ...
                for (let t = 0; t < n.length; t++) {
                    const s = e[i + t];
                    n[t]._custom = l(s[2], this.itemsolveDataElementOptions(t + i).radius)
                }
                return n
            }
            parseObjectData(t, e, i, s) {
                ...
                for (let t = 0; t < n.length; t++) {
                    const s = e[i + t];
                    n[t]._custom = l(s && s.r && +s.r, this.itemsolveDataElementOptions(t + i).radius)
                }
                return n
            }
            getMaxOverflow() {
                ...
                for (let i = t.length - 1; i >= 0; --i)
                    e = Math.max(e, t[i].size(this.itemsolveDataElementOptions(i)) / 2);
                return e > 0 && e
            }
            getLabelAndValue(t) {
                const e = this._cachedMeta
            ...
            updateElements(t, e, i, s) {
                ...
                for (let d = e; d < e + i; d++) {
                    ...
                    l && (u.options = r || this.itemsolveDataElementOptions(d, e.active ? "active" : s),
            ...
            resolveDataElementOptions(t, e) {
                ...
                let s = super.itemsolveDataElementOptions(t, e);
        ...
        LineController: class extends Ns {
            ...
            update(t) {
                ...
                i.points = s;
                const l = this.itemsolveDatasetElementOptions(t);
            ...
            updateElements(t, e, i, n) {
                ...
                for (let i = 0; i < _; ++i) {
                    ...
                    p && (_.parsed = v,
                    _.raw = h.data[i]),
                    d && (_.options = c || this.itemsolveDataElementOptions(i, g.active ? "active" : n)),
            ...
            getMaxOverflow() {
                ...
                if (!s.length)
                    return i;
                const n = s[0].size(this.itemsolveDataElementOptions(0))
                  , o = s[s.length - 1].size(this.itemsolveDataElementOptions(s.length - 1));
        ...
        RadarController: class extends Ns {
            ...
            update(t) {
                ...
                if (i.points = s,
                "resize" !== t) {
                    const e = this.itemsolveDatasetElementOptions(t);
            ...
            updateElements(t, e, i, s) {
                ...
                for (let a = e; a < e + i; a++) {
                    const e = t[a]
                      , i = this.itemsolveDataElementOptions(a, e.active ? "active" : s)
        ...
        ScatterController: class extends Ns {
            ...
            update(t) {
                ...
                this.options.showLine) {
                    ...
                    n.points = i;
                    const a = this.itemsolveDatasetElementOptions(t);
            ...
            updateElements(t, e, i, n) {
                const o = "reset" === n
                  , {iScale: a, vScale: r, _stacked: l, _dataset: h} = this._cachedMeta
                  , c = this.itemsolveDataElementOptions(e, n)
                ...
                for (let c = e; c < e + i; ++c) {
                    ...
                    m && (p.parsed = i,
                    p.raw = h.data[c]),
                    u && (p.options = d || this.itemsolveDataElementOptions(c, e.active ? "active" : n)),
            ...
            getMaxOverflow() {
                ...
                if (!this.options.showLine) {
                    ...
                    for (let i = e.length - 1; i >= 0; --i)
                        t = Math.max(t, e[i].size(this.itemsolveDataElementOptions(i)) / 2);
                    return t > 0 && t
                }
                const i = t.dataset
                ...
                if (!e.length)
                    return s;
                const n = e[0].size(this.itemsolveDataElementOptions(0))
                  , o = e[e.length - 1].size(this.itemsolveDataElementOptions(e.length - 1));
